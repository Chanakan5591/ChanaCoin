...
// Copyright (c) 2019, The ChanaCoin Project
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 215;
...
const char     CRYPTONOTE_NAME[]                             = "ChanaCoin";
...
const int      P2P_DEFAULT_PORT                              =  17535;
const int      RPC_DEFAULT_PORT                              =  17636;
const int      SERVICE_DEFAULT_PORT                          =  17353;
...
const char     LATEST_VERSION_URL[]                          = "http://kancloud.zyxel.me:5000/MyWeb/ChanakanCloud/ChanaCoin/lastest";
const std::string LICENSE_URL                                = "https://github.com/turtlecoin/turtlecoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb3, 0x22, 0x11, 0x24, 0x56, 0x34, 0x12, 0x12, 0x64, 0x36, 0x75, 0x24, 0x22, 0x11, 0x44, 0x33  }
};
